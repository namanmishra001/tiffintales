  ...
  return (
    <section className="py-20 bg-saffron-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Testimonials */}
        <div>
          <h3 className="text-2xl font-serif font-bold text-center mb-10">What Our Happy Eaters Say</h3>
          <div className="grid md:grid-cols-3 gap-6">
            {TESTIMONIALS.map((t, idx) => (
              <div key={idx} className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm relative">
                <Quote className="absolute top-4 right-4 text-saffron-200 w-8 h-8" />
                ...
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-gray-200 rounded-full mr-3 flex items-center justify-center text-xs font-bold text-gray-500">
                    {t.name.charAt(0)}
                  </div>
                  <div>
